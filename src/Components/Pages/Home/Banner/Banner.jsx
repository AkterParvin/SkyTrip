        ...
        <>
            ...
            <div className="w-full h-[90vh] relative">
                <img
                    ...
                    alt=""
                />
                <div className="relative w-full h-full  bg-gray-900/40 z-0">
                    <svg
                        className="absolute inset-x-0 -bottom-64 text-white"
                    ...
                    <div className="relative  z-20 px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                        <div className="flex flex-col items-center justify-between xl:flex-row">
                            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                                <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none z-20">
                                ...
                                <a
                                    href="/"
                                    aria-label=""
                                    className="inline-flex items-center font-semibold tracking-wider transition-colors duration-200 bg-gray-100  px-3 py-1 rounded-3xl text-teal-accent-400 hover:text-teal-accent-700"
                                >
                                    Learn more
                                    <svg
